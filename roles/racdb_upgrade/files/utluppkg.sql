Rem $Header: rdbms/admin/utluppkg.sql /st_rdbms_12.1.0.2.0dbbp/4 2015/04/10 12:23:44 sschodav Exp $
Rem
Rem utluppkg.sql
Rem
...
Rem    sschodav    04/10/15 - Backport
Rem                           apfwkr_blr_backport_8889083_12.1.0.2.6dbbp from
Rem                           st_rdbms_12.1.0.2.0dbbp
Rem    apfwkr      02/24/15 - Backport
Rem                           apfwkr_ci_backport_19873610_12.1.0.2.3dbpsu from
Rem                           st_rdbms_12.1.0.2.0dbpsu
Rem    apfwkr      04/05/15 - Backport
Rem                           apfwkr_blr_backport_8889083_12.1.0.2.4dbbp from
Rem                           st_rdbms_12.1.0.2.0dbbp
Rem    apfwkr      01/26/15 - Backport apfwkr_blr_backport_19902195_12.1.0.2.0
Rem    apfwkr      01/07/15 - Backport hvieyra_bug-19873610 from main
Rem                           from st_rdbms_12.1
Rem    apfwkr      01/28/15 - Backport hvieyra_blr_backport_8889083_12.1.0.2.0
Rem    apfwkr      09/19/14 - Backport apfwkr_blr_backport_19195895_12.1.0.2.0
Rem                           from st_rdbms_12.1
...
Rem    hvieyra     12/19/14 - Backport hvieyra_bug-8889083 from main
...
BEGIN
  ...
  ELSE
    ...
    DisplayLine ('Database log mode:  ' || db_log_mode );
    IF is_db_readonly = TRUE THEN
